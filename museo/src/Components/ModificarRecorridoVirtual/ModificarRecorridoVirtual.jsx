...
const ModificarRecorridoVirtual = () => {
  ...
  return (
    <div>
      ...
      <div className="editar">
        <div className="text">Edita la informacion del recorrido</div>

      </div>
      <div className="botones">
      <form method='POST'>
      <textarea name="texto" id="texto" cols="30" rows="20" className='textArea' placeholder={data.recorrido}>{data.recorrido}</textarea>
...
export default ModificarRecorridoVirtual
